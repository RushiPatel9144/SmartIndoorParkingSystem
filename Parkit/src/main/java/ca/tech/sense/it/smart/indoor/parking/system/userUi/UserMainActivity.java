package ca.tech.sense.it.smart.indoor.parking.system.userUi;
...
import ca.tech.sense.it.smart.indoor.parking.system.userUi.menu.MenuHandler;
import ca.tech.sense.it.smart.indoor.parking.system.utility.DialogUtil;
import ca.tech.sense.it.smart.indoor.parking.system.utility.NotificationHelper;

public class UserMainActivity extends MenuHandler implements NavigationBarView.OnItemSelectedListener {
        ...
        OnBackPressedCallback callback = new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                ...
                if (currentFragment instanceof Home || currentFragment instanceof Park ||
                    ...
                    DialogUtil.showLeaveAppDialog(UserMainActivity.this, getString(R.string.confirm_exit),
